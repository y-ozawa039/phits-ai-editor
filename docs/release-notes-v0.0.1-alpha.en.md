...
[日本語](release-notes-v0.0.1-alpha.md) | English
...
running it. Full installation, first-run, update, and uninstall instructions
are available in the
[`installation.en.md` guide](https://github.com/y-ozawa039/phits-ai-editor/blob/v0.0.1-alpha/docs/installation.en.md).
...
[`installation.en.md` guide](https://github.com/y-ozawa039/phits-ai-editor/blob/v0.0.1-alpha/docs/installation.en.md)
and
[`known issues`](https://github.com/y-ozawa039/phits-ai-editor/blob/v0.0.1-alpha/docs/known-issues-v0.0.1-alpha.en.md),
