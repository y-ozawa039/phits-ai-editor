...
This guide covers the `0.0.4-alpha` distribution for Windows 11 x64. PHITS AI
...
| --- | --- | --- |
| `PHITS-AI-Editor-v0.0.4-alpha-windows-x64-setup.exe` | Normal use | Yes |
| `PHITS-AI-Editor-v0.0.4-alpha-windows-x64-portable.zip` | Evaluation, side-by-side versions, development, and investigation | No |
...
`0.0.4-alpha` is not code-signed, so Windows SmartScreen may show a warning.
...
```powershell
Get-FileHash .\PHITS-AI-Editor-v0.0.4-alpha-windows-x64-setup.exe -Algorithm SHA256
...
- Review the [known issues](known-issues-v0.0.4-alpha.en.md).
