...
export function CodexPanel(props: CodexPanelProps) {
  ...
  const sandboxCheckLabels = { appServer: "Codex App Server", windowsSandbox: "Sandbox", commandExecution: "Sandbox内コマンド実行", workspaceWrite: "ワークスペース編集" } as const;
