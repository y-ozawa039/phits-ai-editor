...
The current planned release is `v0.0.6-alpha`, published as a GitHub Pre-release
...
- `PHITS-AI-Editor-v0.0.6-alpha-windows-x64-portable.zip`
- `PHITS-AI-Editor-v0.0.6-alpha-windows-x64-setup.exe`
- `SHA256SUMS.txt`
...
2. Create the annotated `v0.0.6-alpha` tag.
