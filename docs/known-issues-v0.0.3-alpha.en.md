# Known issues and limitations for 0.0.3-alpha

[日本語](known-issues-v0.0.3-alpha.md) | English
...
- Direct Codex execution of PHITS, ANGEL, DCHAIN, and PHIG-3D is prohibited. Use
  **Normal run** or **Compute-priority run** in the editor toolbar for PHITS
  calculations.
